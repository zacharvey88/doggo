...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/Trip` | `/_sitemap` | `/airlines` | `/icons/Beaches` | `/icons/Parks` | `/icons/Shops` | `/icons/Vets` | `/modal` | `/newsearch` | `/profile` | `/search` | `/sign-in` | `/sign-up` | `/trips` | `/update`;
