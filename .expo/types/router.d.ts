...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(tabs)` | `/_sitemap` | `/add-accommodation` | `/add-trip` | `/airlines` | `/manage-properties` | `/modal` | `/place-details` | `/profile` | `/reset-password` | `/search` | `/sign-in` | `/sign-up` | `/trips` | `/update` | `/update-password`;
