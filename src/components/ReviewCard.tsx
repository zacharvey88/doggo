    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            setFilteredReviews(
              filteredReviews.filter((r) => r.review_id !== review_id)
            );
      ...
      <View style={styles.reviewMetaContainer}>
        <View style={styles.reviewMeta}>
          <Image
            source={{
              uri: avatar_url
                ? `https://orcurstjttnhckjuhyqb.supabase.co/storage/v1/object/public/avatars/${avatar_url}`
                : "https://orcurstjttnhckjuhyqb.supabase.co/storage/v1/object/public/avatars/avatar_placeholder.png",
            }}
            style={styles.avatar}
          />
          <View>
            ...
            <Text style={styles.date}>
              ...
              on {dateFormat(created_at, "dd mmmm yyyy")}
            </Text>
          </View>
        </View>
