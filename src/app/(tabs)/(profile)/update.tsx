...
export default function UpdateAccount() {
  const { username: initialUsername, avatarUrl: initialAvatarUrl, fullname: initialFullname, email: initialEmail } = useLocalSearchParams();
    ...
    <View style={styles.container}>
      ...
      <View style={[styles.verticallySpaced, styles.mt20]}>
        <Button
          ...
          onPress={() => updateProfile({ username, avatar_url: avatarUrl, fullname })}
          disabled={loading}
        />
      </View>
    </View>
