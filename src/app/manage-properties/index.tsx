...
const ManageProperties: React.FC<AccommodationListItemProps> = () => {
    ...
    // const handleEditTrip = async (accommodation_id) => {
    //     // Implementation needed
    //   }
    
    //   const handleDeleteTrip = async (accommodation_id) => {
    //     setTripId(accommodation_id);
    ...
    async function getAccommodation() {
        setLoading(true);
        const { data } = await supabase.from('accommodation').select('*').eq("user_id", session?.user.id);
        if (data) {
